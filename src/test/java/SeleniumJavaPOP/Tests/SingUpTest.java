...
////        logedUserPage.checkHeading(firstName);
...
//        System.out.println(singUp.errorList().stream().collect(Collectors.joining(", ")));
        ...
        softAssert.assertTrue(singUp.errorList().contains(communicateKeyList.get("emptyEmail")) || singUp.errorList().contains(communicateKeyList.get("invalidEmail")), "The e-mail is OK");
